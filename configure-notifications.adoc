...
| 复制延迟 | 复制花费的时间比预期的要长。 | 复制 | 批判的 | 常规存储 | FSx for ONTAP文件系统 


| 自定义仪表板创建成功 | 您的自定义仪表板已成功创建并可供查看。 | 自定义仪表板 | 成功 | 常规存储 | 工作负载工厂帐户 


| 自定义仪表板创建失败 | Workload Factory 无法创建您的自定义仪表板。请尝试重新创建仪表板。 | 自定义仪表板 | 错误 | 常规存储 | 工作负载工厂帐户 
|===
